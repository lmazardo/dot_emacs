...
(defun color-theme-ryan ()
  ...
  (color-theme-install
   '(color-theme-ryan
     ...
     (mmm-face ((t (nil))))
     (mode-line ((t (:background "ForestGreen" :foreground "gainsboro" :box (:line-width 1 :style none) :width condensed :family "neep"))))
     ...
     (show-paren-match-face ((t (:background "pink" :foreground "black" :bold t))));;))))
